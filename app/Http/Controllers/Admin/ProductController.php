...
class ProductController extends Controller
{
    ...
    public function StoreProduct(Request $request){
        $request->validate([
            ...
            'price' => 'required',
            'quantity' => 'required',
            'product_short_des' => 'required|unique:products',
            'product_long_des' => 'required|unique:products',
        ...
        $img_name = hexdec(uniqid()).'.'. $image->getClientOriginalExtension(); // Name gen
