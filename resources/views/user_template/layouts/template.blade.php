...
<head>
    ...
    <!-- Title  -->
    <title>DatShop - Best Shop To Buy</title>
...
<header class="header_area">
    <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
        ...
        <nav class="classy-navbar" id="essenceNav">
            <!-- Logo -->
            <a class="nav-brand" href="{{route('Home')}}"><img src="{{asset('home/img/core-img/logo.png')}}" alt=""></a>
            <!-- Navbar Toggler -->
        ...
        <div class="header-meta d-flex clearfix justify-content-end">
            ...
            <!-- Cart Area -->
            <div class="cart-area">
                <a href="#" id="essenceCartBtn"><img src="{{asset('home/img/core-img/bag.svg')}}" alt=""> <span></span></a>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-md-12 text-center">
                <p>
                    ...
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://fb.com/datkingvn" target="_blank">@datkingvn</a></a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
        </div>
