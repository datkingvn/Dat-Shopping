    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
              ...
              <span class="app-brand-logo demo">
                ...
                >
                  ...
                  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">@datkingvn</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-header small text-uppercase">
                    <span class="menu-header-text">Sub Cagetory</span>
                </li>
                ...
                <!-- Layouts -->
                <li class="menu-header small text-uppercase">
                    <span class="menu-header-text">Cagetory</span>
                </li>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <!-- định nghĩa một vị trí trong tệp giao diện (template) để chèn nội dung từ các trang khác vào đó -->
                @yield('content')
